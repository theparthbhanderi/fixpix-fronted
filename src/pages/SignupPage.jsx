...
import { Lock, User as UserIcon, Mail, Eye, EyeOff, Sun, Moon, ArrowLeft } from 'lucide-react';
...
const SignupPage = () => {
    ...
    return (
        ...
        >
            ...
            <motion.button
                onClick={() => navigate(-1)}
                className="absolute top-6 left-6 w-10 h-10 rounded-full flex items-center justify-center text-text-secondary hover:text-text-main transition-colors"
                            ...
                            <div>
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="input-field"
                                        style={{ paddingLeft: 'var(--space-9)', paddingRight: '48px' }}
